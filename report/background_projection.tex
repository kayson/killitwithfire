OBS har inte hunnit redigera denna text. helt så jag fixar formler osv runt 19 tiden. Viktor du kan ta bort stycken om det överlappar med det du skrivit.

The last step so solve in the in the Navier-Stokes equation is the pressure step, which is also called the projection step, by its linear algebraic properties of a Projection. This step enforces that the velocity field is divergence free and therefore incompressible, by calculating a pressure field p which satisfies this property, Eq X (navierstokes pressure + divergensfritt). 
