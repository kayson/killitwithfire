...
{
\label{fig:fire5}
A burning blue core visualised as a surface.
}
\end{figure}Link to a video which demonstrates all the results in the figures:

\href{http://youtu.be/F40_rowaLQg}{http://youtu.be/F40\_rowaLQg}
